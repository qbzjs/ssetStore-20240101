...
namespace razz
{
    ...
    public class InteractorObject : MonoBehaviour
    {
        ...
        public void RotateToV3(Vector3 rotateToPosition)
        {
            ...
            if (!pivotX) _tempRotation.x = pivot.eulerAngles.x;
            if (!pivotY) _tempRotation.y = pivot.eulerAngles.y;
            if (!pivotZ) _tempRotation.z = pivot.eulerAngles.z;
            ...
            pivot.eulerAngles = _tempRotation;
        }
