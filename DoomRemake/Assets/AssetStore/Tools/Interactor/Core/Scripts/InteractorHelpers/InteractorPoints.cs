...
namespace razz
{
    ...
    {
        [Tooltip("")] public Transform bodyPoint;
        [Tooltip("")] public Transform bodyPointEnd;
        [Tooltip("")] public float endSpeedMult = 1f;
        [Tooltip("")] [ReadOnly] public Transform currentObject;
