...
namespace razz
{
    ...
    public class Interactor : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            if (_interactorIK && _interactorIK.Animator && _interactorIK.Animator.isHuman)
            {
                _leftElbow = _interactorIK.Animator.GetBoneTransform(HumanBodyBones.LeftLowerArm);
                _rightElbow = _interactorIK.Animator.GetBoneTransform(HumanBodyBones.RightLowerArm);
            }
            ...
            if (lookAtTargetEnabled)
            {
                ...
                else
                {
                    if (_interactorIK)
                    {
                        if (_interactorIK.Animator && _interactorIK.Animator.isHuman)
                        {
                            Transform headTransform = _interactorIK.Animator.GetBoneTransform(HumanBodyBones.Head);
        ...
        public class EffectorLink
        {
            ...
            private bool OrbitalCheck(Transform targetTransform)
            {
                ...
                if (targetTransform.position.y - _playerTransform.position.y > _interactor.orbitalReach.maxHeight + _interactor.orbitalReach.maxMargin || targetTransform.position.y < _interactor.orbitalReach.minHeight - _interactor.orbitalReach.maxMargin) return false;
