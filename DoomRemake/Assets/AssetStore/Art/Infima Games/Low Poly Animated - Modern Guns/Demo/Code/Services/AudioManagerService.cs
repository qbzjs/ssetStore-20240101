...
namespace InfimaGames.Animated.ModernGuns
{
    ...
    public class AudioManagerService : MonoBehaviour, IAudioManagerService
    {
        ...
        private void PlayOneShot_Internal(AudioClip clip, AudioSettings settings)
        {
            ...
            //Set Loop.
            newAudioSource.loop = settings.Loop;
            //Set Audio Mixer Group.
            newAudioSource.outputAudioMixerGroup = settings.Output;
        ...
        /// <param name="settings"></param>
        public void PlayOneShot(AudioClip[] clips, AudioSettings settings = default)
        {
            //Play.
            PlayOneShot_Internal(clips[Random.Range(0, clips.Length)], settings);
        }
