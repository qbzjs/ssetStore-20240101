...
public class THC5_ctrl : MonoBehaviour {
	...
	{		
		...
		{
			anim.SetInteger ("moving", 12);//walk/run/
			runSpeed = 1;
		}
		if (Input.GetKeyUp ("down")) 
		{
			anim.SetInteger ("moving", 0);//backpedal
		...
		if (Input.GetKeyDown ("o")) 
			{
				anim.SetInteger ("moving", 14); //die-fall
				runSpeed = 0f;
			}
		if (Input.GetKeyDown ("l")) //rise_up
		{ 
