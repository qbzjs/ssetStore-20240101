...
namespace InfimaGames
{
    ...
    public class CharacterKinematics : MonoBehaviour
    {
        ...
        /// AlphaIKHandLeft.
        /// </summary>
        private readonly int AlphaIKHandLeft = Animator.StringToHash("Alpha IK Hand Left");
        /// <summary>
        /// AlphaIKHandRight.
        /// </summary>
        private readonly int AlphaIKHandRight = Animator.StringToHash("Alpha IK Hand Right");
        ...
        private void Run()
        {
            ...
            alphaLeft = characterAnimator.GetFloat(AlphaIKHandLeft);
            //Get Right Constraint Alpha.
            alphaRight = characterAnimator.GetFloat(AlphaIKHandRight);
